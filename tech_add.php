                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Add new faults </h6>
                                </div>
                                <!--Form that lets admin or tech add faults-->
                                <form name="f1" action="addo.php" method="POST">
                                    <div class="form-group" style="margin: auto">
                                        <label for="email">Area:</label>
                                        <input type="text" class="form-control" id="area" name= "area" style="width: 80%;" required>

                                        <label for="comment">Latest update:</label>
                                        <textarea class="form-control" rows="5" id="update" name="update" style="width: 80%;" required></textarea>
                                        <br>
                                        <label for="Progress" class="form-label">Progress 0% -100%</label>
                                        <br>
                                        <input type="text" class="form-control" id="progress" name= "progress" style="width: 80%;" required>
                                        <br>
                                        <input type =  "submit" class="btn btn-primary" style="" value="Add">
                                    </div> 
                                </form>
                            </div>
                        </div>
