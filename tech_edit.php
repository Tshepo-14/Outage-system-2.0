...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="tech_add.php">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Add Faults</span></a>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ongoing Faults</h1>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" class="form-control" id="Area" placeholder="Enter area where there is a outage">
                                
                                <!-- Describe what the outage is and what we are doing-->
                                <label for="exampleInputEmail1"> Outage Information  </label>
                                <input type="text" class="form-control" id="info" placeholder="What are we currently doing">
                            </div>

                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-mdb-dismiss="modal fade">Close</button>
                    ...
                    <div class="row">
                        ...
                        <?php
                            $sqlv="select * from outages";
                            $result= mysqli_query($con, $sqlv);
                            $detailv=0
                        ?>
                            <!-- Project Card Example -->
                            <!--<form name="f1" action="addo.php" method="GET">-->
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Ongoing faults </h6>
                                         
                                        </div>
                                        <!-- Start loop to check through all  -->
                                        ...
                                        ?>
                                        <!--<a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">-->
                                            <a href="editz.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"> Edit </a>

                                            <a href="server.php?del=<?php echo $row['id']; ?>" class="btn btn-danger" style="float: right;"> Delete</a>
                                        </div>
                                        
                                        <div class="card-body">
                                            <h4 class="small font-weight-bold"><?php echo $row['city']; ?> <span
                                                    class="float-right"><?php echo $row['progress'];?> %</span></h4>
                                            <div class="progress mb-4">
                                               
                                            </div>
                                            <div>
                                                <h6> <?php echo $row['outages']; ?> </h6>
                                            </div>
                                            <hr>
                                           <?php } ?>
                                        </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">Select yes below if you want to delete record</div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                    <a class="btn btn-primary" href="delete.php">Yes</a>
                </div>
            </div>
        </div>
    </div>

    <!-- Create another Modal for editing faults-->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <label for="email">Area:</label>
                    <input type="text" class="form-control" id="text" name= "area" style="width: 80%;">
                <br>
                <label for="comment">Latest update:</label>
                <textarea class="form-control" rows="5" id="comment" name="update" style="width: 80%;"></textarea>
                <br>
                <label for="Progress" class="form-label">Progress 0% -100%</label>
                <br>
                <input type="text" class="form-control" id="progress" name= "progress" style="width: 80%;">
                <br>
