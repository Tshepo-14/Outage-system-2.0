...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin_index.php">
                ...
                <div class="sidebar-brand-text mx-3">Outage System Register Technician</div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group" hidden>
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Tech ID ..."
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown" data-target="#profileModal">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <!-- Create a php block to save all curent registered technicians count-->
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">  Register new Tech </h6>
                                ...
                                <div class="card-body">
                                           ...
                                           <form name ="f2" action="register.php" method="POST"><!--Form to save new tech ID,  username and password-->
                                            <div class="form-group">
                                              <label for="email">Tech ID</label>
                                              <input type="text" class="form-control" id="techid" name="techid" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <input type =  "submit" class="btn btn-primary" style="" value="Save">
                                          </form> 
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      ...
      <!-- Modal to edit profile e.g password-->
