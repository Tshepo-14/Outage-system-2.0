                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <span class="font-weight-bold">5 users from Cape Town have reported a fault</span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <form name="f1" action="addo.php" method="POST">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            <h4 class="small font-weight-bold">Klerksdorp <span
                                            ...
                                            <div>
                                                <h6>Currently There is a fibre break in klerksdorp technicians are busy splicing 
                                                    2000 metres from klerksdorp pop
                                                </h6>
                                            </div>
                                            <hr>
