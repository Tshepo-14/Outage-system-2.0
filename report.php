    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                ...
                <h3 class="mb-5"><em>System administrator will be notified of problem in area, in the mean time please make sure there is 
                    power to unit and system has been rebooted.
                    <h3> Please find reference number ###########</h3>
                </em></h3>
